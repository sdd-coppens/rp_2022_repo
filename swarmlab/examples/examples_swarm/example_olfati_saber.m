function score_scaled = example_olfati_saber(random_scale, random_scale_scale, nb_agents)
    ...
    if exist('app', 'var')
        ...
        DEBUG = app.debug_plot;
            ...
            %algo_change = 'no_front_no_bounce';
    ...
    weighted_score_run = (0.3 * collision_percentage_obstacle + 0.3 * collision_percentage_agents + 0.2 * mean(order) + 0.2 * mean(alg_conn));
